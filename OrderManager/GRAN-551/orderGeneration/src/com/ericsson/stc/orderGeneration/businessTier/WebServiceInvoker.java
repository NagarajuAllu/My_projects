...
public class WebServiceInvoker {
  ...
  public String invoke(ServiceData serviceData) throws InvokerException {
    ...
    try {
      ...
      soapMsg = soapMsg.replaceAll("CUSTOMER_NUMBER", serviceData.getServiceCustomerNumber()).
                        ...
                        replaceAll("SERVICE_NUMBER", serviceData.getServiceNumber()).
                        replaceAll("PATH_NAME", serviceData.getPathName()).
                        replaceAll("ACCESS_NUMBER", serviceData.getAccessNumber()).
                        replaceAll("COMPUTED_SITE_A", serviceData.getComputedSiteA()).
                        replaceAll("COMPUTED_SITE_B", serviceData.getComputedSiteB()).
                        replaceAll("PLATE_ID", (serviceData.getPlateId() != null ? serviceData.getPlateId() : ""));
      ...
      httpURLConnection.setRequestProperty("User-Agent", "DSLSKY_SUBMITORDER_TOOL (java 1.7)");
