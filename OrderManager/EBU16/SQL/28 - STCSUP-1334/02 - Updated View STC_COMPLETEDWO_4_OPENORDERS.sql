...
SELECT p.process_id, l.cwDocId, l.serviceNumber, l.cwOrderId, l.workOrderNumber, l.elementTypeInOrderTree, h.orderNumber, w.element_type, w.element_inst_id, v.status_name
 ...
 WHERE p.process_metadatype = t.typeid
   AND t.typename in ('processSTC.mainSTCProvisiongProcess', 'processSTC.mainSTCProvisiongProcess_NoParticipant', 'processSTC.mainSTCProvisiongProcess_NoParticipant_2', 'processSTC.mainSTCProvisiongProcess_NoParticipant_3')
   AND p.status = 1
