...
SELECT p.process_id, 
 ...
 WHERE p.process_metadatype = t.typeid
   AND t.typename in ('stcw.mainSTCWProvisiongProcess', 'stcw.mainSTCWProvisiongProcess_2', 'stcw.mainSTCWProvisiongProcess_3', 'stcw.mainSTCWProvisiongProcess_4', 'stcw.mainSTCWProvisiongProcess_5', 
                      'stcw.mainSTCWQuoteProvisioningProcess', 'stcw.mainSTCWQuoteProvisioningProcess_2', 'stcw.mainSTCWQuoteProvisioningProcess_3', 'stcw.mainSTCWQuoteProvisioningProcess_4')
   AND p.status = 1
