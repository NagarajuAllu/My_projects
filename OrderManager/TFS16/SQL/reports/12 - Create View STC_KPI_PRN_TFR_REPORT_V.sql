create or replace view stc_kpi_prn_tfr_report_v as
select prnr.customer_name,
 ...
 where prn.prnr_id = prnr.prnr_id
   ...
   and prn.prn_id not in (select distinct bir.source_prn_id
                            from tfs.stc_bi_relationship bir
