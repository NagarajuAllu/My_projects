...
public class ServiceData {
  ...
  public String getRemarks() {
    return "MIGRATED FROM ICMS : " +
           ...
           (_customerNumber != null ? _customerNumber : "") + ", " +
           (_accountNumber != null ? _accountNumber : "") + ", " +
           (_accessNumber != null ? _accessNumber : "") + ", " +
           (_circuitCategory != null ? _circuitCategory : "") + ", " +
           (_siteA != null ? _siteA : "") + ", " +
           (_siteB != null ? _siteB : "") + ", " +
           (_bandwidth != null ? _bandwidth : "") + ", " +
           (_functionCode != null ? _functionCode : "") + ", " +
           (_rtnSpeed != null ? _rtnSpeed : "") + ", " +
           (_msIsdn != null ? _msIsdn : "") + ", " +
           (_simNumber != null ? _simNumber : "") + ", " +
           (_mvpnAccessType != null ? _mvpnAccessType : "") + ", " +
           (_mvpnSpeed != null ? _mvpnSpeed : "");
  }
}
